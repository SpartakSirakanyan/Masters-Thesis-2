...
Հաշվողական գրաֆը այն գրաֆն է, որտեղ գագաթները (հանգույցները) իրենցից ներկայացնում են մաթեմատիկական գործողություններ (օրինակ՝ գումարում, բազմապատկում, և այլն), իսկ  եզրերը (կողերը) իրենցից ներկայացնում են տվյալներ (փոփոխականներ կամ միջանկյալ արդյունքներ)։
