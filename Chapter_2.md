...
Այստեղից հետևում է որ, եթե x= a-ի փոխարեն տեղադրենք f(x) ֆունկցիայում  x= a+bξ  արժեքը, ապա կստանանք և՛  ֆունկցիայի արժեքը  x= a  կետում, այսինքն f(a)-ն,  և՛ f(x) ֆունկցիայի ածանցյալի արժեքը  x= a  կետում, այսինքն f^' (a)-ն։ Դիտարկենք հետևյալ օրինակը.
