...
Այսպիսով $[0;1]$ հատվածի վրա $y(x)$ անընդհատ ֆունկցիայի փոխարեն կդիտարկենք դիսկրետ արգումենտի ֆունկցիա՝ $y_h(x_i)$,  $i = 0,1,\dots,N$։ Ֆունկցիայի արժեքները հաշվարկվում են ցանցի հանգույցներում $(x_i$-ում), իսկ ֆունկցիան կախված է ցանցի քայլից $(h$-ից)։
