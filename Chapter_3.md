...
Գծելով և կառուցելով ուղիղները զուգահեռ համապատասխան առանցքներին (Նկ. 3.1), ստանում ենք ուղղանկյուն ցանց, որի հանգույցները (կետերը) տրված են $(x_i, t_j)$ զույգերով, որտեղ $x_i = i h$,  $t_j = j \tau$,  
$i = 0,1,\dots,N_1$,  $j = 0,1,\dots,N_2$։ $\overline{\omega}_{h\tau}$-ով նշանակենք $(x_i, t_j)$ կետերի բազմությունը $\overline{D}$ տիրույթում։
